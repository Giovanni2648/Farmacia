...
$usuario = "phpmyadmin"; // usuario de la base de datos
$contraseña = "!Podrida11111010101"; // contraseña de la base de datos
$base_de_datos = "farmacia"; // nombre de la base de datos
